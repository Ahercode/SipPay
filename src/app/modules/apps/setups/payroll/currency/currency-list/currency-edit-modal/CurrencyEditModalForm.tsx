...
const CurrencyEditModalForm: FC<Props> = ({currency, isCurrencyLoading}) => {
  ...
  const [CurrencyForEdit] = useState<Currency>({
    ...currency,
    // avatar: Currency.avatar || initialCurrency.avatar,
    role: currency.role || initialCurrency.role,
    position: currency.position || initialCurrency.position,
    name:currency.name || initialCurrency.name,
    email:currency.email || initialCurrency.email,
  })
  ...
  // const CurrencyAvatarImg = toAbsoluteUrl(`/media/${CurrencyForEdit.avatar}`)
  ...
  return (
    <>
      <form id='kt_modal_add_currency_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div
          ...
          <div className='fv-row mb-7'>
            ...
            > */}
              ...
              {/* <div
                ...
                style={{backgroundImage: `url('${CurrencyAvatarImg}')`}}
              ></div> */}
      ...
      {(formik.isSubmitting || isCurrencyLoading) && <CurrencyListLoading />}
    </>
  )
}
