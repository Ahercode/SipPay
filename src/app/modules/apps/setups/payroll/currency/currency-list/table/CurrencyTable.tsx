...
import {currencyColumns} from './columns/_columns'
...
const CurrencyTable = () => {
  const currencys = useQueryResponseData()
  const isLoading = useQueryResponseLoading()
  const data = useMemo(() => currencys, [currencys])
  const columns = useMemo(() => currencyColumns, [])
