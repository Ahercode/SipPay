...
import {initialParameter, Parameter} from '../core/_models'
import clsx from 'clsx'
import {useListView} from '../core/ListViewProvider'
import {ParametersListLoading} from '../components/loading/ParametersListLoading'
import {createParameter, updateParameter} from '../core/_requests'
...
const ParameterEditModalForm: FC<Props> = ({parameter, isParameterLoading}) => {
  const {setItemIdForUpdate} = useListView()
  const {refetch} = useQueryResponse()

  const [parameterForEdit] = useState<Parameter>({
    ...parameter,
    // avatar: Parameter.avatar || initialParameter.avatar,
    role: parameter.role || initialParameter.role,
    position: parameter.position || initialParameter.position,
    name: parameter.name || initialParameter.name,
    email: parameter.email || initialParameter.email,
  })
  ...
  // const ParameterAvatarImg = toAbsoluteUrl(`/media/${ParameterForEdit.avatar}`)
  ...
  return (
    <>
      <form id='kt_modal_add_Parameter_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div
        ...
        >
          ...
          <div className='fv-row mb-7'>
            ...
            > */}
              ...
              {/* <div
                ...
                style={{backgroundImage: `url('${ParameterAvatarImg}')`}}
              ></div> */}
          ...
          <div className='fv-row mb-7'>
            ...
            <input
              ...
              autoComplete='off'
              disabled={formik.isSubmitting || isParameterLoading}
            />
        ...
        <div className='text-center pt-15'>
          ...
          <button
            ...
            disabled={isParameterLoading || formik.isSubmitting || !formik.isValid || !formik.touched}
          >
            <span className='indicator-label'>Submit</span>
            {(formik.isSubmitting || isParameterLoading) && (
      ...
      {(formik.isSubmitting || isParameterLoading) && <ParametersListLoading />}
    </>
  )
}
