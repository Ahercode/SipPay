...
import {initialLeave, Leave} from '../core/_models'
import clsx from 'clsx'
import {useListView} from '../core/ListViewProvider'
import {LeavesListLoading} from '../components/loading/LeavesListLoading'
import {createLeave, updateLeave} from '../core/_requests'
...
const LeaveEditModalForm: FC<Props> = ({leave, isLeaveLoading}) => {
  const {setItemIdForUpdate} = useListView()
  const {refetch} = useQueryResponse()

  const [LeaveForEdit] = useState<Leave>({
    ...leave,
    // avatar: Leave.avatar || initialLeave.avatar,
    role: leave.role || initialLeave.role,
    position: leave.position || initialLeave.position,
    name: leave.name || initialLeave.name,
    email: leave.email || initialLeave.email,
  })
  ...
  // const LeaveAvatarImg = toAbsoluteUrl(`/media/${LeaveForEdit.avatar}`)

  const formik = useFormik({
    initialValues: LeaveForEdit,
  ...
  return (
    <>
      <form id='kt_modal_add_Leave_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div
        ...
        >
          ...
          <div className='fv-row mb-7'>
            ...
            > */}
              ...
              {/* <div
                ...
                style={{backgroundImage: `url('${LeaveAvatarImg}')`}}
              ></div> */}
          ...
          <div className='fv-row mb-7'>
            ...
            <input
              ...
              autoComplete='off'
              disabled={formik.isSubmitting || isLeaveLoading}
            />
        ...
        <div className='text-center pt-15'>
          ...
          <button
            ...
            disabled={isLeaveLoading || formik.isSubmitting || !formik.isValid || !formik.touched}
          >
            <span className='indicator-label'>Submit</span>
            {(formik.isSubmitting || isLeaveLoading) && (
      ...
      {(formik.isSubmitting || isLeaveLoading) && <LeavesListLoading />}
    </>
  )
}

export {LeaveEditModalForm}
