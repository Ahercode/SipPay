...
const GradeEditModalForm: FC<Props> = ({grade, isGradeLoading}) => {
  ...
  return (
    <>
          ...
          <div className='fv-row mb-7'>
            ...
            > */}
              ...
              {/* <div
                ...
                style={{backgroundImage: `url('${GradeAvatarImg}')`}}
              ></div> */}
      ...
      {(formik.isSubmitting || isGradeLoading) && <GradesListLoading />}
    </>
  )
}
