...
const nationalityColumns: ReadonlyArray<Column<Nationality>> = [
  ...
  // },
  {
    Header: (props) => <NationalityCustomHeader tableProps={props} title='Code' className='min-w-125px' />,
    id: 'code',
  ...
  {
    Header: (props) => (
      <NationalityCustomHeader tableProps={props} title='Status' className='min-w-125px' />
    ),
    accessor: 'status',
  },
  {
