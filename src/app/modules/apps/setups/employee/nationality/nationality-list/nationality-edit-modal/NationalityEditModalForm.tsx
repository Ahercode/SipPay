...
import {initialNationality, Nationality} from '../core/_models'
import clsx from 'clsx'
import {useListView} from '../core/ListViewProvider'
import {NationalityListLoading} from '../components/loading/NationalityListLoading'
import {createNationality, updateNationality} from '../core/_requests'
import {useQueryResponse} from '../core/QueryResponseProvider'

type Props = {
  isNationalityLoading: boolean
...
const NationalityEditModalForm: FC<Props> = ({nationality, isNationalityLoading}) => {
  ...
  // const NationalityAvatarImg = toAbsoluteUrl(`/media/${NationalityForEdit.avatar}`)

  const formik = useFormik({
    initialValues: NationalityForEdit,
    validationSchema: editNationalitychema,
    onSubmit: async (values, {setSubmitting}) => {
      setSubmitting(true)
      try {
        if (isNotEmpty(values.id)) {
          await updateNationality(values)
        } else {
  ...
  return (
    <>
      <form id='kt_modal_add_Nationality_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div
          ...
          <div className='fv-row mb-7'>
            ...
            > */}
              ...
              {/* <div
                ...
                style={{backgroundImage: `url('${NationalityAvatarImg}')`}}
              ></div> */}
        ...
        <div className='text-center pt-15'>
          ...
          <button
            ...
            disabled={isNationalityLoading || formik.isSubmitting || !formik.isValid || !formik.touched}
          >
            <span className='indicator-label'>Submit</span>
            {(formik.isSubmitting || isNationalityLoading) && (
      ...
      {(formik.isSubmitting || isNationalityLoading) && <NationalityListLoading />}
    </>
  )
}

export {NationalityEditModalForm}
