...
import {initialDivision, Division} from '../core/_models'
import clsx from 'clsx'
import {useListView} from '../core/ListViewProvider'
import {DivisionsListLoading} from '../components/loading/DivisionsListLoading'
import {createDivision, updateDivision} from '../core/_requests'
...
const editDivisionSchema = Yup.object().shape({
  email: Yup.string()
...
const DivisionEditModalForm: FC<Props> = ({division, isDivisionLoading}) => {
  ...
  // const divisionImg = toAbsoluteUrl('/media/svg/avatars/blank.svg')
  // const DivisionAvatarImg = toAbsoluteUrl(`/media/${DivisionForEdit.avatar}`)

  const formik = useFormik({
    initialValues: DivisionForEdit,
  ...
  return (
    <>
      <form id='kt_modal_add_division_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div
          ...
          <div className='fv-row mb-7'>
            ...
            > */}
              ...
              {/* <div
                ...
                style={{backgroundImage: `url('${DivisionAvatarImg}')`}}
              ></div> */}
        ...
        <div className='text-center pt-15'>
          ...
          <button
            ...
            disabled={isDivisionLoading || formik.isSubmitting || !formik.isValid || !formik.touched}
          >
            <span className='indicator-label'>Submit</span>
            {(formik.isSubmitting || isDivisionLoading) && (
      ...
      {(formik.isSubmitting || isDivisionLoading) && <DivisionsListLoading />}
    </>
  )
}

export {DivisionEditModalForm}
