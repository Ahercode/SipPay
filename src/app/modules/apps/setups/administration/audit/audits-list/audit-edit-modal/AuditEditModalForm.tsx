...
import {initialAudit, Audit} from '../core/_models'
import clsx from 'clsx'
import {useListView} from '../core/ListViewProvider'
import {AuditsListLoading} from '../components/loading/AuditsListLoading'
import {createAudit, updateAudit} from '../core/_requests'
...
const AuditEditModalForm: FC<Props> = ({audit, isAuditLoading}) => {
  ...
  const [AuditForEdit] = useState<Audit>({
    ...audit,
    // avatar: Audit.avatar || initialAudit.avatar,
    role: audit.role || initialAudit.role,
    position: audit.position || initialAudit.position,
    name: audit.name || initialAudit.name,
    email: audit.email || initialAudit.email,
  })
  ...
  // const AuditAvatarImg = toAbsoluteUrl(`/media/${AuditForEdit.avatar}`)

  const formik = useFormik({
    initialValues: AuditForEdit,
  ...
  return (
    <>
      <form id='kt_modal_add_Audit_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div
        ...
        >
          ...
          <div className='fv-row mb-7'>
            ...
            > */}
              ...
              {/* <div
                ...
                style={{backgroundImage: `url('${AuditAvatarImg}')`}}
              ></div> */}
          ...
          <div className='fv-row mb-7'>
            ...
            <input
              ...
              autoComplete='off'
              disabled={formik.isSubmitting || isAuditLoading}
            />
        ...
        <div className='text-center pt-15'>
          ...
          <button
            ...
            disabled={isAuditLoading || formik.isSubmitting || !formik.isValid || !formik.touched}
          >
            <span className='indicator-label'>Submit</span>
            {(formik.isSubmitting || isAuditLoading) && (
