...
const CompanyEditModalForm: FC<Props> = ({company, isCompanyLoading}) => {
  ...
  const [CompanyForEdit] = useState<Company>({
    ...
    role: company.role || initialCompany.role,
    position: company.position || initialCompany.position,
  ...
  // const CompanyAvatarImg = toAbsoluteUrl(`/media/${CompanyForEdit.avatar}`)
  ...
  return (
    <>
      <form id='kt_modal_add_company_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div
          ...
          <div className='fv-row mb-7'>
            ...
            > */}
              ...
              {/* <div
                ...
                style={{backgroundImage: `url('${CompanyAvatarImg}')`}}
              ></div> */}
